classdef BehaviorBox8 < hgsetget
    % ---------------------------------------------------------------------
    % BehaviorBox
    % Han Lab
    % 7/11/2011
    ...
    methods % Initialization
        function obj = BehaviorBox8(varargin)
            ...
            obj.default = struct(...
                ...
                'pauseTime',0.5,...
                'rewardTime',.2,...% reward time 0.15 for SS4 #4 #8 #11 to motivate. 
                'punishTime',10,...%
...
%             % Transition to Wait4Poke Phase
        ...
        function startPauseFcn(obj,src,evnt)
            ...
            %obj.rewardTime = 1; % increase the reward time to 0.5 6/1/2012
        end
