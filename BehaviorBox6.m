classdef BehaviorBox6 < hgsetget
    % ---------------------------------------------------------------------
    % BehaviorBox
    % Han Lab
    % 7/11/2011
    ...
    methods % Initialization
        function obj = BehaviorBox6(varargin)
            ...
            obj.default = struct(...
                ...
                'pauseTime',0.5,...
                'rewardTime',.2,...% reward time increased from .2 to .4. so mice get more water jz 1/5/2012
                'punishTime',10,...%
                'stimSet',{{[2 6];[6 2]}},...% design for trainging widnows in [3 5]
                'correctResponse',{{2;6}},...
